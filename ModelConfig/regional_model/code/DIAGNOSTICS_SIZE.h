C $Header: /u/gcmpack/MITgcm_contrib/high_res_cube/code-mods/DIAGNOSTICS_SIZE.h,v 1.11 2008/05/05 23:15:13 dimitri Exp $
C $Name:  $
...
C  and "diagSt_size" (statistics-diags) since values here are deliberately small.
      ...
      PARAMETER( numdiags = 10+30*Nr )
      PARAMETER( nRegions = 1 , sizRegMsk = 1 , nStats = 4 )
